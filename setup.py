...
extensions = [
    ...
    Extension("plugins.SerpentOzymandiasGameAgentPlugin.files.helpers.classifier.main", 
        ...
        library_dirs=[]),
    # rf learner
    Extension("plugins.SerpentOzymandiasGameAgentPlugin.files.helpers.rf_agent.main", 
        ["plugins/SerpentOzymandiasGameAgentPlugin/files/helpers/rf_agent/main.pyx"],
        include_dirs=[],
        libraries=[],
        library_dirs=[]),
    # statemachine
